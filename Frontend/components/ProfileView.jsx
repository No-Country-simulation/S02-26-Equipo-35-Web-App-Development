      ...
      <div className='row g-4 mb-5'>
        ...
        <div className='col-lg-8'>
          <div className='card border-0 shadow-lg rounded-5 bg-dark text-white h-100 overflow-hidden position-relative'>
            <div
              className='position-absolute top-0 end-0 translate-middle-y mt-5 me-n5 bg-primary bg-opacity-25 rounded-circle blur-3xl opacity-25'
              style={{ width: "300px", height: "300px" }}
            ></div>
            <div className='card-body p-4 p-md-5 position-relative z-1'>
              <div className='d-flex justify-content-between align-items-start mb-5'>
                <div>
                  <h6 className='text-white text-opacity-50 text-uppercase fw-bold mb-3 small tracking-widest'>
                    {t("profile.plan")}
                  </h6>
                  <div className='h1 fw-bold d-flex align-items-center mb-0'>
                    <Zap
                      className='w-8 h-8 text-warning me-3'
                      fill='currentColor'
                    />
                    Professional
                  </div>
                  <p className='small text-white text-opacity-50 mt-2 mb-0 fw-medium'>
                    Next billing cycle: Oct 24, 2024
                  </p>
                </div>
                <Button
                  size='sm'
                  variant='white'
                  className='rounded-pill px-4 text-dark border-0 hover-translate-y'
          ...
          <div className='card border-0 shadow-sm rounded-5 h-100 bg-card border-base'>
            <div className='card-body p-4 p-md-5'>
              ...
              <div className='d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom border-base'>
                <div>
                  <label className='d-block h6 fw-bold text-base mb-1'>
                    {t("settings.theme")}
                  </label>
        ...
        <div className='col-md-6'>
          <div className='card border-0 shadow-sm rounded-5 h-100 bg-card border-base'>
            <div className='card-body p-4 p-md-5 d-flex flex-column align-items-center justify-content-center'>
              ...
              <p className='text-muted small text-center mb-4 px-lg-5'>
                Ensure your account is secure by managing active sessions.
              </p>
              <button
