      ...
      <div className='card h-100 border-0 shadow-sm rounded-5 overflow-hidden project-card transition-all hover-translate-y'>
        <div className='card-body p-3'>
          <div className='d-flex align-items-center'>
            <div
              className='position-relative bg-secondary bg-opacity-10 rounded-4 overflow-hidden shadow-sm'
            ...
            <div className='ms-3 flex-grow-1 overflow-hidden'>
              <div className='d-flex justify-content-between align-items-start mb-1'>
                <h6 className='text-dark fw-bold mb-0 text-truncate pe-2'>
                  {project.file_name}
                </h6>
              ...
              <div className='d-flex align-items-center pt-2'>
                <div
                  className={`p-1 rounded-circle me-2 d-flex align-items-center ${
    ...
    <div className='card h-100 border-0 shadow-sm rounded-5 overflow-hidden project-card transition-all hover-translate-y group bg-card border-base'>
      ...
      >
        ...
        <div className='position-absolute top-0 end-0 m-3 z-1'>
          <span
            className={`badge rounded-pill bg-dark bg-opacity-80 backdrop-blur text-white px-3 py-2 fw-bold text-uppercase border border-white border-opacity-10 ${project.status === "processing" ? "text-warning" : ""}`}
            style={{ fontSize: "0.6rem", letterSpacing: "0.05rem" }}
          >
            {getStatusText(project.status)}
          </span>
        </div>
      ...
      <div className='card-body p-4 pt-3'>
        <div className='d-flex justify-content-between align-items-center mb-2'>
          <h6
            className='fw-bold text-base text-truncate mb-0 pe-2'
        ...
        <div className='d-flex align-items-center justify-content-between pt-2'>
          ...
          <div
            className='small font-monospace text-muted opacity-50'
